...
def detectFace(testImage):
    ...
    faces = classifier.detectMultiScale(grayImage, scaleFactor=1.32, minNeighbors=5)
            ...
            for picture in pictures:
                ...
                # If picture is valid
                    ...
                    # Process training picture with 1 face [EDIT]
                        ...
                        faces.append(cropFacePart)
                        labels.append(int(personID))
                        print(f"Image {picture.split('/')[-1]} processed successfully!")
...
def identify(name, trainDir, testImage=None):
    ...
    def writeShow(testImage):
        cv2.imwrite("HaarCascade.jpg", testImage)
        # os.system("brave HaarCascade.jpg")
